...
import { resolveSymbolAtPosition, type ResolveSymbolAtPositionResult } from './symbolResolve';
...
{
    return resolveSymbolAtPosition(asmodule, position, includeDocumentation, GetDefinition);
}
